...
export default function CreateEmployee({ onSuccess, onCancel }: CreateEmployeeProps) {
  ...
  return (
    <div className="w-full">
      <div className="mb-6">
        <h2 className="text-xl text-textBold text-gray-900">Create Single User</h2>
          ...
          <Form className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label htmlFor="first_name" className="text-sm text-textBold text-gray-700">First Name</label>
                <Field
                  id="first_name"
                  name="first_name"
                ...
                />
                <ErrorMessage name="first_name" component="div" className="text-primary-red text-xs mt-1" />
              </div>

              <div className="space-y-1.5">
                <label htmlFor="last_name" className="text-sm text-textBold text-gray-700">Last Name</label>
                <Field
                  id="last_name"
                  name="last_name"
                  placeholder="e.g. Doe"
                  className="w-full bg-white border border-gray-300 focus:border-primary-blue focus:ring-1 focus:ring-primary-blue rounded-lg px-3 py-2.5 text-sm outline-none transition-all placeholder:text-gray-400"
                />
                <ErrorMessage name="last_name" component="div" className="text-primary-red text-xs mt-1" />
              </div>
            </div>

            <div className="space-y-1.5">
              <label htmlFor="email" className="text-sm text-textBold text-gray-700">Email Address</label>
              <Field
                id="email"
                name="email"
                type="email"
            ...
            <div className="space-y-1.5">
              <label htmlFor="payroll_no" className="text-sm text-textBold text-gray-700">Payroll Number</label>
              <Field
                id="payroll_no"
                name="payroll_no"
                ...
                className="w-full bg-white border border-gray-300 focus:border-primary-blue focus:ring-1 focus:ring-primary-blue rounded-lg px-3 py-2.5 text-sm outline-none transition-all placeholder:text-gray-400"
              />
              <ErrorMessage name="payroll_no" component="div" className="text-primary-red text-xs mt-1" />
            </div>
