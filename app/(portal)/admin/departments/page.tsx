    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white rounded p-4 border border-gray-200 shadow-sm flex items-center gap-3">
          <div className="w-10 h-10 rounded bg-manager-orange/10 text-manager-orange flex items-center justify-center shrink-0">
        ...
        <div className="bg-white rounded p-4 border border-gray-200 shadow-sm flex items-center gap-3">
          <div className="w-10 h-10 rounded bg-primary-blue/10 text-primary-blue flex items-center justify-center shrink-0 border border-primary-blue/20">
      ...
      <div className="bg-white rounded border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <span className="text-xs text-gray-500">
            Showing <strong className="text-gray-900 font-semibold">{filteredDepartments?.length || 0}</strong> of{" "}
          ...
          <table className="w-full text-left border-collapse text-sm">
            <thead>
              <tr className="bg-gray-50/70 text-gray-500 text-xs font-semibold uppercase tracking-wider border-b border-gray-100">
                ...
                <th className="px-6 py-3.5 font-medium">Unit / Branch</th>
                <th className="px-6 py-3.5 font-medium">Supervisor / Head</th>
                <th className="px-6 py-3.5 font-medium text-center">Staff Members</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-8 text-center text-primary-red text-sm">
                  ...
                  >
                    <td className="px-6 py-3.5">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded bg-manager-orange/10 border border-manager-orange/20 flex items-center justify-center text-manager-orange font-semibold text-xs shrink-0 group-hover:bg-manager-orange group-hover:text-white transition-colors">
                          {dept.name?.[0] || "D"}
                        </div>
                        <div>
                    ...
                    <td className="px-6 py-3.5">
                      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-primary-blue/5 text-primary-blue border border-primary-blue/15 text-xs font-semibold">
                    ...
                    <td className="px-6 py-3.5">
                      {dept.supervisor ? (
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded bg-gray-100 flex items-center justify-center text-gray-700 text-xs font-semibold shrink-0">
                    ...
                    <td className="px-6 py-3.5 text-center">
                      <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-gray-100 text-gray-700 text-xs font-medium border border-gray-200">
